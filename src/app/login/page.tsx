...
const TelegramIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M16.9999 8.00001L8.49992 11.5C7.99992 11.7 7.99992 12.3 8.49992 12.5L10.4999 13.2C10.7999 13.3 11.0999 13.6 11.1999 13.9L11.8999 15.9C12.0999 16.4 12.6999 16.4 12.8999 15.9L16.9999 8.00001Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export default function LoginPage() {
  ...
  return (
    // Убираем Header, оставляем только PageContainer как корневой элемент
    <PageContainer className="flex min-h-screen items-center justify-center bg-zinc-50 py-12">
      <div className="w-full max-w-sm">
        <div className="space-y-5 rounded-lg border border-zinc-200 bg-white p-8 text-center shadow-sm">
          ...
          {/* Центрируем логотип */}
          <div className="mx-auto flex h-12 w-auto justify-center text-indigo-600">
            <Logo />
          </div>
          ...
          <form className="space-y-4 text-left" onSubmit={handleLoginSubmit}>
            <div>
              <input
                ...
                className="block w-full rounded-md border-zinc-300 bg-zinc-50 px-3 py-2 text-sm placeholder-zinc-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label htmlFor="remember-me" className="ml-2 block text-xs text-zinc-700">Сохранить вход</label>
              </div>
            </div>
